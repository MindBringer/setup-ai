...
local ubuntu_iso=“ubuntu-24.04.2-live-server-amd64.iso”
...
if [[ ! -f "$iso_path/$ubuntu_iso" ]]; then
    ...
    log "Ubuntu 24.04.2 LTS ISO erfolgreich heruntergeladen"
else
    log "Ubuntu 24.04.2 LTS ISO bereits vorhanden"
fi
...
final_message: “Ubuntu 24.04.2 LTS Server Installation abgeschlossen. SSH ist verfügbar.”
EOF
...
echo -e “\n${GREEN}=== Ubuntu 24.04.2 LTS Server VM Installation Abgeschlossen ===${NC}\n”
